...
def init_dataset_normalize(train_set_size=0, test_set_size=0):
    """
...
def initialize_parameters():
    ...
    W1 = tf.get_variable('W1', [3, 3, 1, 4], initializer=tf.contrib.layers.xavier_initializer(seed=0))
...
def forward_propagation(X, parameters, keep_prob):
    ...
    W1 = parameters['W1']
    assert W1.shape == (3,3,1,4)
    W2 = parameters['W2']
    assert W2.shape == (2,2,4,8)
